...
\usepackage{verbatim}
\usepackage{enumitem}
\usepackage[colorlinks=true, urlcolor=qiushiblue, pdfborder={0 0 0}, pdftex]{hyperref}
\usepackage{fancyhdr}
...
\begin{center}
  ...
  Email: \href{mailto:your@email.com}{your@email.com} \hspace{2em}
  GitHub: {\href{https://github.com/your-github-id}{\color{qiushiblue}your-github-id}}
\end{center}
...
\section{论文及在投}
  \resumeSubHeadingListStart
    \item[{\textbf{[1]}}] Example Paper Title A: Placeholder Subtitle for Open-Source Template \\
      作者A, 作者B, \textbf{你的姓名（示例）}, 作者C* \\
      \textbf{Under Review} \textit{Target Journal / Conference}
    \vspace{-2pt}
    \item[{\textbf{[2]}}] Example Paper Title B: Placeholder Subtitle for Open-Source Template \\
...
\section{项目经历}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {\href{https://example.com}{\color{qiushiblue}机器人策略方法复现项目 A（示例）}}{某高校}
      {项目复现}{2026.1 - 2026.4}
      \resumeItemListStart
    ...
    \resumeSubheading
      {\href{https://example.com}{\color{qiushiblue}机器人策略方法复现项目 B（示例）}}{某高校}
      {项目复现}{2026.1 - 2026.4}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {课程项目}{2025.2 - 2025.3}
      \resumeItemListStart
        \item[\textbullet] 完成课程核心任务的设计与实现，包括理论推导、仿真验证与实验调试。
        \item[\textbullet] 基于结果分析提出优化方向，完整呈现项目执行与闭环总结能力。
      \resumeItemListEnd
